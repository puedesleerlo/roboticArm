...
import { Bone } from './bone.class';
 ...
 export class Chain2D {
    ...
    baseboneConstraintUV = new V2();
    baseboneRelativeConstraintUV = new V2();
    fixedBaseMode = true;
    lastTargetLocation = new V2( MAX_VALUE, MAX_VALUE );
    lastBaseLocation =  new V2( MAX_VALUE, MAX_VALUE );

    boneConnectionPoint = END;
    
    currentSolveDistance = MAX_VALUE;
    connectedChainNumber = -1;
    connectedBoneNumber = -1;

    embeddedTarget = new V2();
